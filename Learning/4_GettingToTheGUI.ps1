...
Start-PoshWebGUI -ScriptBlock {
    ...
    switch ($Context.Request.Url.LocalPath)
    {
        ...
        "/loadProcesses" { Get-Process $Context.Request.QueryString["ProcessName"] | select cpu,name | ConvertTo-Html | Out-String }
        "/loadServices" { Get-Service $Context.Request.QueryString["ServiceName"] | select Status,Name,DisplayName | ConvertTo-Html | Out-String }
